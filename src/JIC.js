...
var jic = {
         ...
         * @param {Integer} Scale Percentage. Possible values are 0..100
        ...
        compress: function(source_img_obj, quality, output_format, scale){
             ...
             cvs.width = scale === undefined ? source_img_obj.naturalWidth
                            : (scale/100) * source_img_obj.naturalWidth;

             cvs.height = scale === undefined ? source_img_obj.naturalHeight
                            : (scale/100) * source_img_obj.naturalHeight;
